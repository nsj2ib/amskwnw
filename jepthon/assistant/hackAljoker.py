...
'''
mm = '''
قم بلأنضمام الى قناة الجوكر @WWEEHHHH
'''
...
keyboard = [
  ...
  [
    Button.url("سورس الجوكر 🤡", "https://t.me/WWEEHHHH")
    ]
]
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/L_URD")
            ]
        ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if len(i) > 1:
        ...
        await event.reply(i + "\n\nشكراً لأستخدامك 𝑠𝑜𝑢𝑟𝑠𝑒 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒 ❤️. \n/hack", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك 𝑠𝑜𝑢𝑟𝑠𝑒 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك 𝑠𝑜𝑢𝑟𝑠𝑒 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك 𝑠𝑜𝑢𝑟𝑠𝑒 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/WWEEHHHH")
        ]
    ]
